# https://tomron.net/2016/02/27/spark-emr-lambda-aws/
# https://stackoverflow.com/questions/45795776/how-to-execute-spark-submit-on-amazon-emr-from-lambda-function
import sys
import time
